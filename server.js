...
// Definimos a porta como variável de ambiente (process.env.PORT)
// para funcionar em plataformas de nuvem como Heroku, Render ou Vercel.
// Caso estejamos rodando localmente, usará a porta 3000 como fallback.
...
// =============================================================
// ── NOVO NA AULA 7: Exportação para Deploy Serverless (Vercel)
// Para que a Vercel consiga rodar a nossa API, precisamos
// exportar o 'app' para que ele seja tratado como uma função serverless.
// =============================================================
module.exports = app;
